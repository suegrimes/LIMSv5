...
protected
  ...
  def define_conditions(params)
    @where_select, @where_values = build_sql_where(params[:storage_query], SampleLoc::QUERY_FLDS, [], [])

    dt_fld = params[:storage_query][:date_filter]
    if dt_fld == 'samples.sample_date'
